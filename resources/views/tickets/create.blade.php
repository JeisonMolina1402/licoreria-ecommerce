...
<div class="container-fluid p-0">
    <div class="row g-0">
        ...
        <nav class="col-md-2 d-none d-md-block bg-dark sidebar" style="min-height: 100vh;">
            <div class="position-sticky pt-4">
                ...
                <ul class="nav flex-column text-white px-2">
                    <li class="nav-item mb-2"><a class="nav-link text-white" href="{{ route('home') }}">📊 Dashboard</a></li>
                    <li class="nav-item mb-2"><a class="nav-link text-white" href="{{ route('inventario') }}">📦 Inventario</a></li>
                    <li class="nav-item mb-2"><a class="nav-link active-menu" href="{{ route('tickets.index') }}">🎟️ Tickets</a></li>
        ...
        <main class="col-md-10 bg-light p-3" style="min-height: 100vh;">
