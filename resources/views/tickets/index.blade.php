...
@section('content')
    <form action="{{ route('tickets.index') }}" method="GET" class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            <div class="row g-2">
                <div class="col-md-5">
                    <input type="text" class="form-control" name="buscar_codigo" placeholder="🔍 Buscar por código de reserva..." value="{{ request('buscar_codigo') }}">
                </div>
                <div class="col-md-4">
                                        ...
                                        <div class="modal-content border-0 shadow-lg">
                                            ...
                                            <div class="modal-body bg-light">
                                                <div class="mb-3 text-muted small">
                                                    <strong>Cajero/Cliente:</strong> {{ $ticket->user->name ?? 'Desconocido' }} <br>
                                                    <strong>Fecha de emisión:</strong> {{ $ticket->created_at->format('d/m/Y h:i A') }}
                                                </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-sm table-bordered bg-white mb-0 text-nowrap">
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                <th colspan="3" class="text-end fs-6">Total a Pagar:</th>
                                                                <th class="text-end fs-6 text-success">${{ number_format($ticket->total, 2) }}</th>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
                                                </div>
