...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;600&family=Playfair+Display:ital,wght@0,400;0,700;1,400&family=Cinzel:wght@400;700&family=Lora:wght@400;600&display=swap" rel="stylesheet">
    ...
    <style>
        .footer-link, .footer-contact-list p { transition: color 0.3s ease; }
        .footer-link:hover, .footer-contact-list p i:hover { color: #d1b48c !important; }
        .social-icon-footer-link { transition: transform 0.3s ease; }
        .social-icon-footer-link:hover { transform: scale(1.1); }
    </style>
</head>
...
<body>
    ...
    <nav class="navbar navbar-tienda fixed-top py-2 shadow-sm">
        <div class="container-fluid px-2 px-lg-5 d-flex justify-content-between align-items-center flex-nowrap">
            ...
            <div class="d-flex align-items-center" style="flex: 1;">
                <button class="btn border-0 d-lg-none p-1 nav-icon" type="button" data-bs-toggle="offcanvas" data-bs-target="#menuMovil">
            ...
            <div class="d-flex justify-content-center" style="flex: 1;">
                <a class="navbar-brand m-0 d-flex align-items-center" href="{{ route('tienda.index') }}">
                    <img src="{{ asset('images/logos/logo.png') }}" alt="Licorería Premium" style="height: clamp(45px, 6vw, 70px);">
                </a>
            </div>

            <div class="d-flex justify-content-end align-items-center gap-3 gap-lg-4" style="flex: 1;">
                
                <div class="d-none d-lg-flex align-items-center gap-2 gap-lg-4">
                    @auth
                        @hasanyrole('admin|vendedor')
                            <a href="{{ route('home') }}" class="nav-icon p-1" title="Ver Panel"><i class="fa-solid fa-chart-column fs-5"></i><span class="nav-text d-none d-lg-inline text-uppercase ms-1">Administración</span></a>
                        @endhasanyrole
                        @unlessrole('admin|vendedor')
                            <a href="{{ route('tienda.mis-pedidos') }}" class="nav-icon p-1" title="Ver mis Pedidos"><i class="fa-solid fa-ticket fs-5"></i><span class="nav-text d-none d-md-inline text-uppercase ms-1">Pedidos</span></a>
                        @endunlessrole

                        <div class="dropdown">
                            <button class="nav-icon dropdown-toggle border-0 bg-transparent p-1" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fa-regular fa-circle-user fs-5"></i><span class="nav-text d-none d-md-inline text-uppercase ms-1">{{ explode(' ', Auth::user()->name)[0] }}</span>
                            </button>
                    ...
                    @else
                        <a href="{{ route('login') }}" class="nav-icon p-1"><i class="fa-regular fa-user fs-5"></i><span class="nav-text d-none d-md-inline text-uppercase ms-1">Entrar</span></a>
                        <a href="{{ route('register') }}" class="nav-icon p-1"><i class="fa-solid fa-user-plus fs-5"></i><span class="nav-text d-none d-lg-inline text-uppercase ms-1">Registro</span></a>
                    @endauth
                </div>
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <button class="nav-icon border-0 bg-transparent p-1 pe-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#carritoOffcanvas">
                        <div class="position-relative">
                        ...
                        <span class="nav-text d-none d-md-inline text-uppercase ms-1">Carrito</span>
                    </button>
                </div>
            </div>
        </div>
                ...
                @auth
                    <div class="d-flex align-items-center mb-3 pb-3 border-bottom border-secondary">
                        ...
                        <div style="line-height: 1.2;">
                            <strong class="text-white d-block fs-5">{{ explode(' ', Auth::user()->name)[0] }}</strong>
                    ...
                    <div class="d-flex flex-column gap-1">
                        @hasanyrole('admin|vendedor')
                            <a href="{{ route('home') }}" class="btn btn-dark text-start border-0 text-white-50 w-100 px-2 py-2"><i class="fa-solid fa-chart-column me-2"></i> Administración</a>
                        @endhasanyrole
                        @unlessrole('admin|vendedor')
                            <a href="{{ route('tienda.mis-pedidos') }}" class="btn btn-dark text-start border-0 text-white-50 w-100 px-2 py-2"><i class="fa-solid fa-ticket me-2"></i> Mis Pedidos</a>
                        @endunlessrole
        ...
        <section class="footer mt-2 pt-5 px-5">
            <div class="container">
                <div class="row g-4 text-white">
                    <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center justify-content-center justify-content-lg-start mb-4 mb-lg-0 text-center text-lg-start">
                        <a class="text-decoration-none m-0" href="{{ route('tienda.index') }}">
                            <img src="{{ asset('images/logos/logo.png') }}" alt="Licorería Premium Logo Footer" style="height: 100px; filter: brightness(0) invert(1);">
                        </a>
                    </div>

                    <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center align-items-lg-start text-center text-lg-start mt-4 mt-md-0">
                        <h5 class="text-white mb-3" style="font-family: 'Cinzel', serif; letter-spacing: 1px;">ENLACES PRINCIPALES</h5>
                        <div class="d-flex flex-column gap-2 footer-links-list">
                            <a href="{{ route('tienda.index') }}" class="text-white-50 text-decoration-none small footer-link">Inicio</a>
                            <a href="#" class="text-white-50 text-decoration-none small footer-link">Nuestro Catálogo</a>
                            <a href="{{ route('tienda.mis-pedidos') }}" class="text-white-50 text-decoration-none small footer-link">Ver Mis Pedidos</a>
                            <a href="{{ route('legal.terminos') }}" class="text-white-50 text-decoration-none small footer-link">Términos y Condiciones</a>
                            <a href="{{ route('legal.privacidad') }}" class="text-white-50 text-decoration-none small footer-link">Política de Privacidad</a>
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center align-items-lg-start text-center text-lg-start mt-4 mt-lg-0">
                        <h5 class="text-white mb-3" style="font-family: 'Cinzel', serif; letter-spacing: 1px;">CONTÁCTANOS</h5>
                        <div class="d-flex flex-column gap-3 text-white-50 small footer-contact-list">
                            <p class="m-0"><i class="fas fa-map-marker-alt me-2 text-white-50"></i> Quito, Oe3K y S46F</p>
                            <p class="m-0"><i class="fas fa-phone me-2 text-white-50"></i> +593 981766228</p>
                            <p class="m-0"><i class="fas fa-envelope me-2 text-white-50"></i> contacto@licoreriapremium.com</p>
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-6 d-flex flex-column align-items-center align-items-lg-start text-center text-lg-start mt-4 mt-lg-0">
                        <h5 class="text-white mb-3" style="font-family: 'Cinzel', serif; letter-spacing: 1px;">SÍGUENOS</h5>
                        <div class="d-flex gap-3 social-icons-footer fs-4">
                            <a href="https://www.facebook.com/jeison.molina.399?locale=es_LA" target="_blank" class="text-white social-icon-footer-link"><i class="fa-brands fa-facebook"></i></a>
                            <a href="https://www.instagram.com/jeison_molina2001/" target="_blank" class="text-white social-icon-footer-link"><i class="fa-brands fa-instagram"></i></a>
                            <a href="https://www.tiktok.com/@jeisonm1402" target="_blank" class="text-white social-icon-footer-link"><i class="fa-brands fa-tiktok"></i></a>
                            <a href="https://wa.me/593981766228" target="_blank" class="text-white social-icon-footer-link"><i class="fa-brands fa-whatsapp"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center py-2 pb-4">
                    <div class="col-12 text-center">
                        <p class="mb-0 text-white-50 small" style="font-family: 'Lora', serif;">© {{ date('Y') }} Jeison Molina - Todos los Derechos Reservados</p>
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="offcanvas offcanvas-end shadow" tabindex="-1" id="carritoOffcanvas" style="width: 400px;">
        <div class="offcanvas-header border-bottom">
            <h5 class="titulo-premium mb-0 d-flex align-items-center gap-2"><i class="fa-solid fa-cart-shopping" style="color: var(--color_primario);"></i> Mi Carrito</h5>
        ...
        <div class="offcanvas-body d-flex flex-column p-0">
            ...
            <div class="border-top p-3 bg-light">
                ...
                <form action="{{ route('checkout.procesar') }}" method="POST" id="form-checkout" class="form-cargando">
                    @csrf
                    <input type="hidden" name="carrito_datos" id="carrito_datos" value="">
                    <button type="submit" class="btn btn-black w-100 py-3 rounded-3 disabled" id="btn-procesar-pago" style="font-size: 1rem;">Procesar Reserva</button>
                </form>
            </div>
        </div>
    </div>
