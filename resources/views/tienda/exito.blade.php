...
@section('content')
    <div class="container py-5 mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                ...
                <!-- ========================================== -->
                <!-- PANEL DE INSTRUCCIONES BANCARIAS           -->
                <!-- ========================================== -->
                <div class="alert alert-warning border-warning shadow-sm mb-4 mx-auto text-start" style="max-width: 600px; background-color: #fff9e6;">
                    ...
                    {{-- REGLA DE NEGOCIO: Establece el sentido de urgencia --}}
                    ...
                    <div class="bg-white p-3 border rounded shadow-sm mb-3">
                        ...
                        <ul class="mb-0 small text-dark list-unstyled ms-4" style="font-family: monospace; font-size: 0.9rem;">
                            ...
                            <li class="mb-1"><strong>Número:</strong> 2200113344</li>
                            <li class="mb-1"><strong>Titular:</strong> Licorería Web Store</li>
                ...
                <!-- ========================================== -->
                <!-- NODO DOM: COMPROBANTE VIRTUAL (CANVAS)     -->
                <!-- Este contenedor será fotografiado por JS   -->
                <!-- ========================================== -->
                <div class="mx-auto bg-white p-4 p-md-5 mb-4 shadow position-relative" id="ticket-comprobante" style="max-width: 600px; border: 1px solid #eaeaea;">
                    
                    {{-- TRUCO CSS: repeating-linear-gradient para simular bordes de papel de factura cortado --}}
                    ...
                    <div class="d-flex justify-content-between border-bottom pb-3 mb-3 small" style="font-family: 'Courier New', Courier, monospace;">
                        <div>
                            ...
                            {{-- Saneamiento automático XSS de Blade --}}
                    ...
                    <div class="mb-4 small" style="font-family: 'Courier New', Courier, monospace;">
                        ...
                        {{-- PROGRAMACIÓN DEFENSIVA: Null Coalescing por si eliminan al usuario --}}
                    ...
                    <div class="mb-4">
                        ...
                        {{-- ITERACIÓN DE RELACIONES: Recorre la tabla pivot/detalles asociada a este ticket --}}
                    ...
                    <!-- Advertencia interna del ticket -->
                ...
                <!-- ========================================== -->
                <!-- BOTONES DE ACCIÓN (INTEGRACIÓN)            -->
                <!-- ========================================== -->
                <div class="mt-4 d-flex justify-content-center flex-wrap gap-3">
                    
                    {{-- DATA-ATTRIBUTES: Pasa el código al script exito.js para nombrar el archivo descargado --}}
                    ...
                    {{-- INTEGRACIÓN WHATSAPP (API Deep Linking): El texto va pre-llenado con URL Encoding (%20 = espacio) e incluye el código dinámico del ticket --}}
    ...
    {{-- LIBRERÍA EXTERNA: Inyecta html2canvas para permitir que exito.js funcione --}}
    <script src="https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js"></script>

    {{-- VITE: Carga el script optimizado. Este script debe contener la orden "localStorage.removeItem('carritoLicores');" --}}
